...
export const THEME_PRESETS: readonly ThemePreset[] = [
  ...
  },
  {
    id: 'ember',
    name: 'Ember 暖焰',
    description: '温暖醒目的行动工作台',
    mode: 'light',
    palette: {
      primary: '#B45309', primaryText: '#9B4506', primaryHover: '#92400E', primaryActive: '#78350F',
      primarySoft: '#F6E7D6', background: '#FCF8F2', surface: '#FFFDFA', surfaceRaised: '#FFFDFA',
      surfaceSubtle: '#F6EEE4', codeBackground: '#302119', codeText: '#FAEEE2',
      text: '#39291F', textSecondary: '#705D52', textTertiary: '#705D52',
      border: '#E7D8C8', borderStrong: '#C9AF95', sidebar: '#F6EEE4', sidebarText: '#39291F',
      sidebarMuted: '#705D52', sidebarActive: '#F6E7D6', success: '#287A55', warning: '#94510F',
      danger: '#B42318', info: '#315F9F', focusRing: 'rgba(180, 83, 9, 0.28)',
      shadow: '0 10px 30px rgba(57, 41, 31, 0.08)', shadowStrong: '0 20px 50px rgba(57, 41, 31, 0.15)',
    },
  },
  {
    id: 'dawn',
    name: 'Dawn 晨曦',
    description: '柔和从容的协作界面',
    mode: 'light',
    palette: {
      primary: '#B4235D', primaryText: '#A21E53', primaryHover: '#961C4C', primaryActive: '#7C163E',
      primarySoft: '#F8E3EC', background: '#FCF6F9', surface: '#FFFDFE', surfaceRaised: '#FFFDFE',
      surfaceSubtle: '#F5EAF0', codeBackground: '#32212A', codeText: '#FAEEF3',
      text: '#392733', textSecondary: '#745763', textTertiary: '#745763',
      border: '#E8D6E0', borderStrong: '#CDAEBE', sidebar: '#F5EAF0', sidebarText: '#392733',
      sidebarMuted: '#745763', sidebarActive: '#F8E3EC', success: '#287A55', warning: '#94510F',
      danger: '#B42318', info: '#315F9F', focusRing: 'rgba(180, 35, 93, 0.28)',
      shadow: '0 10px 30px rgba(57, 39, 51, 0.08)', shadowStrong: '0 20px 50px rgba(57, 39, 51, 0.15)',
    },
  },
  {
    id: 'night',
  ...
  },
  {
    id: 'aurora',
    name: 'Aurora 极光',
    description: '深邃紫光的探索界面',
    mode: 'dark',
    palette: {
      primary: '#7545D6', primaryText: '#C6ACFF', primaryHover: '#6536C2', primaryActive: '#552CAC',
      primarySoft: '#392856', background: '#191522', surface: '#221D2F', surfaceRaised: '#2C253B',
      surfaceSubtle: '#30283F', codeBackground: '#120F1A', codeText: '#F3ECFC',
      text: '#F3EDF9', textSecondary: '#C4B5D5', textTertiary: '#AC9CBE',
      border: '#4A3D5D', borderStrong: '#746089', sidebar: '#15111D', sidebarText: '#F3EDF9',
      sidebarMuted: '#C4B5D5', sidebarActive: '#392856', success: '#75C49B', warning: '#E6B071',
      danger: '#F08C99', info: '#93B8ED', focusRing: 'rgba(166, 121, 255, 0.36)',
      shadow: '0 12px 34px rgba(0, 0, 0, 0.28)', shadowStrong: '0 24px 60px rgba(0, 0, 0, 0.42)',
    },
  },
  {
    // 深色使用独立标识，已有 graphite 用户的浅色偏好和色板保持不变。
    id: 'graphite-dark',
    name: 'Graphite 墨岩（深色）',
    description: '中性低眩光的专注工作台',
    mode: 'dark',
    palette: {
      primary: '#53657E', primaryText: '#BACCE3', primaryHover: '#43536C', primaryActive: '#354459',
      primarySoft: '#303E52', background: '#171A20', surface: '#21252D', surfaceRaised: '#2B303B',
      surfaceSubtle: '#303641', codeBackground: '#11141A', codeText: '#EDF2FA',
      text: '#F0F3F8', textSecondary: '#BCC5D2', textTertiary: '#A5B1C1',
      border: '#3E4857', borderStrong: '#647286', sidebar: '#12151B', sidebarText: '#F0F3F8',
      sidebarMuted: '#BCC5D2', sidebarActive: '#303E52', success: '#75C49B', warning: '#E6B071',
      danger: '#F08C99', info: '#93B8ED', focusRing: 'rgba(154, 180, 214, 0.36)',
      shadow: '0 12px 34px rgba(0, 0, 0, 0.28)', shadowStrong: '0 24px 60px rgba(0, 0, 0, 0.42)',
    },
  },
  {
